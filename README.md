...
|---|---|
| 対象年月 | 2026年07月 |
| 公開日 | 2026年09月01日(JARTIC) |
| 都道府県 | 47／47 |
| レコード数 | 4,394,200件 |
| 地図に載るフィーチャ数 | 4,387,840件 |
| 形状異常 | 357,335件（data/parse_report.json に内訳） |
| PMTiles | 309.5MB（R2配信(Range配信)） |
| 収録ズーム | Z9〜Z14 |
| 引ける過去月 | 1か月 |
<!-- dataset:end -->
...
規制種別は仕様書の表4 で**有効なものが73種**あり（82行のうち9行は「未使用」）、そのまま並べても読めないため用途で束ねています（対応表は [`data/regulation_layers.json`](data/regulation_layers.json)）。2026年6月の実データに現れたのは69種です。

用途で束ねられない `77 警笛鳴らせ及び警笛区間` と `91 路面電車停留場` だけが「その他」に入ります。

**下の件数は配信中のタイルのものです。** レイヤー分けを直したので、
`10 高さ制限`・`14 歩行者横断禁止`・`27 軌道敷内通行可`・`84 並進可`・
`101 高齢運転者等標章自動車停車可`・`102 高齢運転者等専用時間制限駐車区間` の
束ね直しは、**次回の月次更新でタイルを作り直したときから**反映されます。
...
|---|---|---|---|
| 118 | 車両通行帯・進行方向別通行区分 | 1／47 | 1,931 |
| 90 | 導流帯 | 1／47 | 507 |
| 62 | 前方優先道路 | 1／47 | 50 |
| 88 | 安全地帯 | 1／47 | 49 |
| 9 | 重量制限 | 1／47 | 6 |
...
| 54 | 優先道路 | 4／47 | 13 |
| 6 | 大型通行禁止 | 5／47 | 312 |
| 13 | 車両進入禁止 | 6／47 | 5,162 |
| 64 | 優先本線車道 | 6／47 | 9 |
| 2 | 特定小型原動機付自転車・自転車用道路 | 7／47 | 17 |
| 92 | 停止線 | 9／47 | 119,976 |
| 53 | 車両の追越し禁止場所 | 10／47 | 64 |
| 49 | 最低速度 | 10／47 | 19 |
| 77 | 警笛鳴らせ及び警笛区間 | 11／47 | 64 |
| 61 | 徐行 | 13／47 | 144 |
| 110 | 車両通行帯 | 14／47 | 3,395 |
| 93 | 二段停止線 | 14／47 | 757 |
| 94 | 左折可 | 14／47 | 142 |
...
| 3 | 通禁（自転車等歩行者用） | 24／47 | 3,711 |
| 16 | 中央線の変移 | 25／47 | 15,932 |
| 83 | 普通自転車の交差点進入禁止 | 26／47 | 511 |
| 8 | 歩行者等通行止め | 27／47 | 631 |
| 19 | 立入禁止部分 | 30／47 | 170 |
| 58 | 進行方向別通行区分 | 31／47 | 49,346 |
| 52 | 進路変更禁止 | 32／47 | 7,980 |
| 24 | 路線バス等優先通行帯 | 34／47 | 222 |
| 57 | 右左折の方法 | 37／47 | 5,606 |
| 5 | 大型自動車等通行止め | 39／47 | 5,353 |
| 116 | 駐方 | 39／47 | 1,997 |
| 111 | 普通自転車専用通行帯 | 39／47 | 403 |
| 20 | 車両通行帯 | 40／47 | 46,527 |
| 7 | 踏切 | 40／47 | 964 |
| 1 | 通行禁止 | 41／47 | 6,613 |
...
| 70 | 駐車可 | 44／47 | 1,412 |
| 14 | 歩行者横断禁止 | 44／47 | 689 |
| 98 | 信号機 | 45／47 | 111,463 |
| 117 | 路側 | 45／47 | 5,717 |
| 56 | 一般原動機付自転車の右折方法（小回り） | 45／47 | 3,946 |
| 12 | 指定方向外進行禁止 | 46／47 | 107,361 |
| 87 | 自転車横断帯 | 46／47 | 36,426 |
| 76 | 停止禁止部分 | 46／47 | 2,889 |
| 65 | 駐停車禁止 | 46／47 | 1,552 |
<!-- availability:end -->
